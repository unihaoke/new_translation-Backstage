...
public interface SubpackageDao extends JpaRepository<Subpackage,String> ,JpaSpecificationExecutor<Subpackage> {
    ...
    @Query(value = "SELECT new com.trans.translation.vo.SubpackageVo(t1.id,t2.title,t2.t_describe,t2.t_language,t2.territory,t2.deadline,t1.userid,t1.taskid,t1.product_id,t1.content,t1.section,t1.translation,t1.t_status,t1.count,t1.text_length) FROM Subpackage t1 LEFT JOIN Product t2 ON t1.product_id = t2.pid WHERE t2.territory=:territory")
    ...
    @Query(value = "SELECT new com.trans.translation.vo.SubpackageVo(t1.id,t2.title,t2.t_describe,t2.t_language,t2.territory,t2.deadline,t1.userid,t1.taskid,t1.product_id,t1.content,t1.section,t1.translation,t1.t_status,t1.count,t1.text_length) FROM Subpackage t1 LEFT JOIN Product t2 ON t1.product_id = t2.pid",
    ...
    @Query(value = "SELECT new com.trans.translation.vo.SubpackageVo(t1.id,t2.title,t2.t_describe,t2.t_language,t2.territory,t2.deadline,t1.userid,t1.taskid,t1.product_id,t1.content,t1.section,t1.translation,t1.t_status,t1.count,t1.text_length) FROM Subpackage t1 LEFT JOIN Product t2 ON t1.product_id = t2.pid WHERE t1.id=:id")
